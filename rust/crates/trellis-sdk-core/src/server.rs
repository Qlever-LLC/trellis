...
where
    ...
    Fut: std::future::Future<Output = HandlerResult<crate::types::TrellisBindingsGetResponse>> + Send + 'static,
{
...
where
    ...
    Fut: std::future::Future<Output = HandlerResult<crate::types::TrellisCatalogResponse>> + Send + 'static,
{
...
where
    ...
    Fut: std::future::Future<Output = HandlerResult<crate::types::TrellisContractGetResponse>> + Send + 'static,
{
