...
fn main() {
    ...
    println!("cargo:rerun-if-changed=../trellis-sdk-auth/src/contract.rs");
    println!("cargo:rerun-if-changed=../trellis-sdk-core/src/contract.rs");
        ...
        &trellis_codegen_rust::GenerateRustParticipantFacadeOpts {
            ...
            alias_mappings: vec![
                trellis_codegen_rust::ParticipantAliasMapping {
                    ...
                    crate_path: Some(manifest_dir.join("../trellis-sdk-auth")),
                },
                trellis_codegen_rust::ParticipantAliasMapping {
                    alias: "core".to_string(),
                    crate_name: "trellis-sdk-core".to_string(),
                    manifest_path: core_manifest_path,
                    crate_path: Some(manifest_dir.join("../trellis-sdk-core")),
                },
            ],
        },
    )
