...
export const CONTRACT_DIGEST = "M9_hNCJEEDkQB-JdeMfzpEIGFwWSm_pqt2Du7BCArsE" as const;

export type AuthGetInstalledContractInput = { digest: string; };
export type AuthGetInstalledContractOutput = { contract: { analysis?: { events: { events: Array<{ key: string; publishCapabilities: Array<string>; subject: string; subscribeCapabilities: Array<string>; wildcardSubject: string; }>; }; namespaces: Array<string>; nats: { publish: Array<{ kind: string; requiredCapabilities: Array<string>; subject: string; wildcardSubject: string; }>; subscribe: Array<{ kind: string; requiredCapabilities: Array<string>; subject: string; wildcardSubject: string; }>; }; resources: { jobs: Array<{ ackWaitMs: number; backoffMs: Array<number>; concurrency: number; defaultDeadlineMs?: number; dlq: boolean; logs: boolean; maxDeliver: number; payload: { schema: string; }; progress: boolean; queueType: string; result?: { schema: string; }; }>; kv: Array<{ alias: string; history: number; maxValueBytes?: number; purpose: string; required: boolean; ttlMs: number; }>; }; rpc: { methods: Array<{ callerCapabilities: Array<string>; key: string; subject: string; wildcardSubject: string; }>; }; subjects?: { subjects: Array<{ key: string; publishCapabilities: Array<string>; subject: string; subscribeCapabilities: Array<string>; }>; }; }; analysisSummary?: { events: number; jobsQueues: number; kvResources: number; namespaces: Array<string>; natsPublish: number; natsSubscribe: number; rpcMethods: number; }; contract: {  }; description: string; digest: string; displayName: string; id: string; installedAt: string; kind: string; resourceBindings?: { jobs?: { namespace: string; queues: {  }; registry?: { bucket: string; }; }; kv?: {  }; }; resources?: { jobs?: { queues: {  }; }; kv?: {  }; }; sessionKey?: string; }; };
...
export type AuthInstallServiceOutput = { contractDigest: string; contractId: string; resourceBindings: { jobs?: { namespace: string; queues: {  }; registry?: { bucket: string; }; }; kv?: {  }; }; sessionKey: string; success: boolean; };
...
export type AuthListInstalledContractsOutput = { contracts: Array<{ analysisSummary?: { events: number; jobsQueues: number; kvResources: number; namespaces: Array<string>; natsPublish: number; natsSubscribe: number; rpcMethods: number; }; description: string; digest: string; displayName: string; id: string; installedAt: string; kind: string; resourceBindings?: { jobs?: { namespace: string; queues: {  }; registry?: { bucket: string; }; }; kv?: {  }; }; sessionKey?: string; }>; };

export type AuthListServicesInput = {  };
export type AuthListServicesOutput = { services: Array<{ active: boolean; capabilities: Array<string>; contractDigest?: string; contractId?: string; createdAt: string; description: string; displayName: string; namespaces: Array<string>; resourceBindings?: { jobs?: { namespace: string; queues: {  }; registry?: { bucket: string; }; }; kv?: {  }; }; sessionKey: string; }>; };
...
export type AuthUpgradeServiceContractOutput = { contractDigest: string; contractId: string; resourceBindings: { jobs?: { namespace: string; queues: {  }; registry?: { bucket: string; }; }; kv?: {  }; }; sessionKey: string; success: boolean; };
