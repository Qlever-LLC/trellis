...
Generated Trellis SDK for contract `trellis.jobs@v1`.
...
- `jobs`: generated contract module with `CONTRACT_ID`, `CONTRACT_DIGEST`, `CONTRACT`, `API`, and `use(...)`
