...
import {
  ...
  AuthPortalsLoginRoutesListSchema,
  AuthPortalsLoginRoutesPutResponseSchema,
  AuthPortalsLoginRoutesPutSchema,
  AuthPortalsLoginRoutesRemoveResponseSchema,
  AuthPortalsLoginRoutesRemoveSchema,
...
const schemas = {
  ...
  AuthPortalsLoginRoutesListRequest: AuthPortalsLoginRoutesListSchema,
  AuthPortalsLoginRoutesListResponse: AuthPortalsLoginRoutesListResponseSchema,
  AuthPortalsLoginRoutesPutRequest: AuthPortalsLoginRoutesPutSchema,
  AuthPortalsLoginRoutesPutResponse: AuthPortalsLoginRoutesPutResponseSchema,
  AuthPortalsLoginRoutesRemoveRequest: AuthPortalsLoginRoutesRemoveSchema,
  AuthPortalsLoginRoutesRemoveResponse:
    AuthPortalsLoginRoutesRemoveResponseSchema,
...
export const TRELLIS_AUTH_RPC = {
  ...
  "Auth.Portals.LoginRoutes.List": {
    version: "v1",
    input: schemaRef("AuthPortalsLoginRoutesListRequest"),
    output: schemaRef("AuthPortalsLoginRoutesListResponse"),
    capabilities: { call: ["admin"] },
    errors: ["AuthError", "UnexpectedError"],
  },
  "Auth.Portals.LoginRoutes.Put": {
    version: "v1",
    input: schemaRef("AuthPortalsLoginRoutesPutRequest"),
    output: schemaRef("AuthPortalsLoginRoutesPutResponse"),
    capabilities: { call: ["admin"] },
    errors: ["AuthError", "ValidationError", "UnexpectedError"],
  },
  "Auth.Portals.LoginRoutes.Remove": {
    version: "v1",
    input: schemaRef("AuthPortalsLoginRoutesRemoveRequest"),
    output: schemaRef("AuthPortalsLoginRoutesRemoveResponse"),
    capabilities: { call: ["admin"] },
    errors: ["AuthError", "ValidationError", "UnexpectedError"],
  },
} as const;
