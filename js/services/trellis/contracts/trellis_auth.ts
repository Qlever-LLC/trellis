...
const schemas = {
  ...
  AuthListCapabilitiesRequest: AuthListCapabilitiesSchema,
  AuthListCapabilitiesResponse: AuthListCapabilitiesResponseSchema,
...
export const TRELLIS_AUTH_RPC = {
  ...
  "Auth.ListCapabilities": {
    version: "v1",
    input: schemaRef("AuthListCapabilitiesRequest"),
    output: schemaRef("AuthListCapabilitiesResponse"),
    capabilities: { call: ["admin"] },
    errors: ["AuthError", "ValidationError", "UnexpectedError"],
  },
  "Auth.UpdateUser": {
