...
function assertComposableApi() {
  ...
  assertNoOverlap("event", trellisCoreApi.owned.events, trellisHealthApi.owned.events);
  assertNoOverlap("event", trellisAuthApi.owned.events, trellisStateApi.owned.events);
  assertNoOverlap("event", trellisAuthApi.owned.events, trellisHealthApi.owned.events);
  assertNoOverlap("event", trellisStateApi.owned.events, trellisHealthApi.owned.events);
  ...
  assertNoOverlap("subject", trellisCoreApi.owned.subjects, trellisHealthApi.owned.subjects);
  assertNoOverlap("subject", trellisAuthApi.owned.subjects, trellisStateApi.owned.subjects);
  assertNoOverlap("subject", trellisAuthApi.owned.subjects, trellisHealthApi.owned.subjects);
  assertNoOverlap("subject", trellisStateApi.owned.subjects, trellisHealthApi.owned.subjects);
  ...
  assertNoOverlap("rpc", trellisCoreApi.trellis.rpc, trellisHealthApi.trellis.rpc);
  assertNoOverlap("rpc", trellisAuthApi.trellis.rpc, trellisHealthApi.trellis.rpc);
  assertNoOverlap("rpc", trellisStateApi.trellis.rpc, trellisHealthApi.trellis.rpc);
  ...
  assertNoOverlap("operation", trellisCoreApi.trellis.operations, trellisHealthApi.trellis.operations);
  assertNoOverlap("operation", trellisAuthApi.trellis.operations, trellisHealthApi.trellis.operations);
  assertNoOverlap("operation", trellisStateApi.trellis.operations, trellisHealthApi.trellis.operations);
  ...
  assertNoOverlap("event", trellisCoreApi.trellis.events, trellisHealthApi.trellis.events);
  assertNoOverlap("event", trellisAuthApi.trellis.events, trellisHealthApi.trellis.events);
  assertNoOverlap("event", trellisStateApi.trellis.events, trellisHealthApi.trellis.events);
  ...
  assertNoOverlap("subject", trellisCoreApi.trellis.subjects, trellisHealthApi.trellis.subjects);
  assertNoOverlap("subject", trellisAuthApi.trellis.subjects, trellisHealthApi.trellis.subjects);
  assertNoOverlap("subject", trellisStateApi.trellis.subjects, trellisHealthApi.trellis.subjects);
}
...
export const trellisControlPlaneApi = {
  owned: {
    ...
    events: { ...trellisCoreApi.owned.events, ...trellisAuthApi.owned.events, ...trellisStateApi.owned.events, ...trellisHealthApi.owned.events },
    subjects: { ...trellisCoreApi.owned.subjects, ...trellisAuthApi.owned.subjects, ...trellisStateApi.owned.subjects, ...trellisHealthApi.owned.subjects },
  },
  trellis: {
    rpc: { ...trellisCoreApi.trellis.rpc, ...trellisAuthApi.trellis.rpc, ...trellisStateApi.trellis.rpc, ...trellisHealthApi.trellis.rpc },
    operations: { ...trellisCoreApi.trellis.operations, ...trellisAuthApi.trellis.operations, ...trellisStateApi.trellis.operations, ...trellisHealthApi.trellis.operations },
    events: { ...trellisCoreApi.trellis.events, ...trellisAuthApi.trellis.events, ...trellisStateApi.trellis.events, ...trellisHealthApi.trellis.events },
    subjects: { ...trellisCoreApi.trellis.subjects, ...trellisAuthApi.trellis.subjects, ...trellisStateApi.trellis.subjects, ...trellisHealthApi.trellis.subjects },
  },
} as const;
