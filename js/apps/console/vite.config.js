...
const config = {
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: "@qlever-llc/trellis/host/deno", replacement: aliasPath("packages/trellis/host/deno.ts") },
      { find: "@qlever-llc/trellis/host/node", replacement: aliasPath("packages/trellis/host/node.ts") },
      { find: "@qlever-llc/trellis/host", replacement: aliasPath("packages/trellis/host/mod.ts") },
