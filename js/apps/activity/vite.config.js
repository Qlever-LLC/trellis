...
const config = {
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@qlever-llc\/trellis-sdk-trellis-core$/, replacement: aliasPath("../generated/js/sdks/trellis-core/mod.ts") },
      { find: "@qlever-llc/trellis-sdk-trellis-core/", replacement: `${aliasPath("../generated/js/sdks/trellis-core")}/` },
      { find: "@qlever-llc/trellis-sdk-activity", replacement: aliasPath("../generated/js/sdks/activity/mod.ts") },
      { find: "@qlever-llc/trellis-sdk-activity/", replacement: `${aliasPath("../generated/js/sdks/activity")}/` },
