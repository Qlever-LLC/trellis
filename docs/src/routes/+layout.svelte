<script lang="ts">
  ...
  const conceptSections = [
    ...
    },
    {
      ...
      label: "Envelopes",
      docs: [
        { href: "/guides/concepts/envelopes#authority-model", label: "Authority model" },
        { href: "/guides/concepts/envelopes#identity-envelopes", label: "Identity envelopes" },
        { href: "/guides/concepts/envelopes#deployment-envelopes", label: "Deployment envelopes" },
        { href: "/guides/concepts/envelopes#boundary-and-delta", label: "Boundary and delta" },
        { href: "/guides/concepts/envelopes#availability-and-liveness", label: "Availability and liveness" },
        { href: "/guides/concepts/envelopes#grant-overrides", label: "Grant overrides" },
        { href: "/guides/concepts/envelopes#contract-evidence", label: "Contract evidence" },
      ],
    },
    {
